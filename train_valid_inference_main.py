...
def train(
    ...
    # freeze u2net weights and train mha
    # for name, param in net.named_parameters():
    #     if "mha" not in name:
    #         param.requires_grad = False


    # unfreeze u2net weights for more compatibility between mha and u2net
...
def main(train_datasets, valid_datasets, hypar):  # model: "train", "test"
    ...
    if hypar["mode"] == "train":
        ...
        train_dataloaders, train_datasets = create_dataloaders(
            ...
            cache_boost=hypar["cache_boost_train"],
            my_transforms=[
                GOSColorJitter(prob=0.7),
                GOSRandomHVFlip(prob=0.5),
                GOSNormalize([0.5, 0.5, 0.5], [1.0, 1.0, 1.0]),
            ],
            batch_size=hypar["batch_size_train"],
            shuffle=True,
...
if __name__ == "__main__":
    ...
    dataset_vd = {
        ...
        "im_ext": ".jpg",
        "gt_ext": ".png",
        "cache_dir": r"C:\Users\RED LINE\Documents\Dataset\REFUGE2\val",
    }
    ...
    if hypar["mode"] == "train":
        ...
        hypar["model_path"] = r"C:\Users\RED LINE\Documents\University Project Code\DIS\saved_models"
        # name of the segmentation model weights .pth for resume training process from last stop or for the inferencing
        hypar["restore_model"] = "gpu_itr_20000_traLoss_0.2225_traTarLoss_0.0103_valLoss_0.0628_valTarLoss_0.01_maxF1_0.9994_mae_0.0018_time_0.034021.pth"
        if hypar["restore_model"] != "":
            ...
            hypar["start_ite"] = 0
        hypar["gt_encoder_model"] = "GTENCODER-gpu_itr_2000_traLoss_0.0723_traTarLoss_0.0114_valLoss_0.0579_valTarLoss_0.0089_maxF1_1.0_mae_0.0008_time_0.021369.pth"
        ...
        hypar["valid_out_dir"] = (
            r"C:\Users\RED LINE\Documents\University Project Code\DIS\Results\ph2"
        )
        # load trained weights from this path
        hypar["model_path"] = (
            r"C:\Users\RED LINE\Documents\University Project Code\DIS\saved_models"
        )
        # "isnet.pth" ## name of the to-be-loaded weights
        hypar["restore_model"] = (
            "gpu_itr_22000_traLoss_0.2467_traTarLoss_0.0105_valLoss_0.0622_valTarLoss_0.0101_maxF1_0.9995_mae_0.0021_time_0.033596.pth"
        )
    ...
    hypar["batch_size_train"] = 3  # batch size for training
