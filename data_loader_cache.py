...
class SegmentationAugmentation:
    def __init__(self, prob_flip=0.5, brightness=0.3, contrast=0.3, saturation=0.3, hue=0.1):
...
class GOSColorJitter(object):
    def __init__(self, brightness=0.4, contrast=0.4, saturation=0.4, hue=0.2,  prob=0.5):
        self.prob = prob
    ...
    def __call__(self, sample):
        ...
        if random.random() < self.prob:
            # Convert image to PIL (ColorJitter expects PIL or uint8 tensor)
